    ...
    flash: {
      ...
      users: {
        ...
        delete: {
          ...
          unknownError: 'Неизвестная ошибка. Не удалось удалить пользователя.',
        },
      ...
      statuses: {
        ...
        update: {
          ...
          unknownError: 'Неизвестная ошибка. Не удалось изменить статус.',
        },
        delete: {
      ...
      tasks: {
        ...
        delete: {
          ...
          unknownError: 'Неизвестная ошибка. Не удалось удалить задачу.',
